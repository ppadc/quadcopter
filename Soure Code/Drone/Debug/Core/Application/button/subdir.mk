...
C_SRCS += \
../Core/Application/button/button.c 

OBJS += \
./Core/Application/button/button.o 

C_DEPS += \
./Core/Application/button/button.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Application/button/%.o Core/Application/button/%.su: ../Core/Application/button/%.c Core/Application/button/subdir.mk
...
clean: clean-Core-2f-Application-2f-button

clean-Core-2f-Application-2f-button:
	-$(RM) ./Core/Application/button/button.d ./Core/Application/button/button.o ./Core/Application/button/button.su

.PHONY: clean-Core-2f-Application-2f-button
