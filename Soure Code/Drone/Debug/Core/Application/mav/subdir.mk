...
C_SRCS += \
../Core/Application/mav/mav.c 

OBJS += \
./Core/Application/mav/mav.o 

C_DEPS += \
./Core/Application/mav/mav.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Application/mav/%.o Core/Application/mav/%.su: ../Core/Application/mav/%.c Core/Application/mav/subdir.mk
...
clean: clean-Core-2f-Application-2f-mav

clean-Core-2f-Application-2f-mav:
	-$(RM) ./Core/Application/mav/mav.d ./Core/Application/mav/mav.o ./Core/Application/mav/mav.su

.PHONY: clean-Core-2f-Application-2f-mav
