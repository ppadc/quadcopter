...
C_SRCS += \
../Core/Application/imu/imu.c 

OBJS += \
./Core/Application/imu/imu.o 

C_DEPS += \
./Core/Application/imu/imu.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Application/imu/%.o Core/Application/imu/%.su: ../Core/Application/imu/%.c Core/Application/imu/subdir.mk
...
clean: clean-Core-2f-Application-2f-imu

clean-Core-2f-Application-2f-imu:
	-$(RM) ./Core/Application/imu/imu.d ./Core/Application/imu/imu.o ./Core/Application/imu/imu.su

.PHONY: clean-Core-2f-Application-2f-imu
