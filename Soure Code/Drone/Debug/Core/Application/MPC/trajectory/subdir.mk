...
C_SRCS += \
../Core/Application/MPC/trajectory/trajectory.c 

OBJS += \
./Core/Application/MPC/trajectory/trajectory.o 

C_DEPS += \
./Core/Application/MPC/trajectory/trajectory.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Application/MPC/trajectory/%.o Core/Application/MPC/trajectory/%.su: ../Core/Application/MPC/trajectory/%.c Core/Application/MPC/trajectory/subdir.mk
...
clean: clean-Core-2f-Application-2f-MPC-2f-trajectory

clean-Core-2f-Application-2f-MPC-2f-trajectory:
	-$(RM) ./Core/Application/MPC/trajectory/trajectory.d ./Core/Application/MPC/trajectory/trajectory.o ./Core/Application/MPC/trajectory/trajectory.su

.PHONY: clean-Core-2f-Application-2f-MPC-2f-trajectory
