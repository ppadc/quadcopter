...
C_SRCS += \
../Core/Application/MPC/mpc.c 

OBJS += \
./Core/Application/MPC/mpc.o 

C_DEPS += \
./Core/Application/MPC/mpc.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Application/MPC/%.o Core/Application/MPC/%.su: ../Core/Application/MPC/%.c Core/Application/MPC/subdir.mk
...
clean: clean-Core-2f-Application-2f-MPC

clean-Core-2f-Application-2f-MPC:
	-$(RM) ./Core/Application/MPC/mpc.d ./Core/Application/MPC/mpc.o ./Core/Application/MPC/mpc.su

.PHONY: clean-Core-2f-Application-2f-MPC
