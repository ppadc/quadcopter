...
C_SRCS += \
../Core/Application/MPC/open_loop_new_states/open_loop_new_states.c 

OBJS += \
./Core/Application/MPC/open_loop_new_states/open_loop_new_states.o 

C_DEPS += \
./Core/Application/MPC/open_loop_new_states/open_loop_new_states.d 


# Each subdirectory must supply rules for building sources it contributes
Core/Application/MPC/open_loop_new_states/%.o Core/Application/MPC/open_loop_new_states/%.su: ../Core/Application/MPC/open_loop_new_states/%.c Core/Application/MPC/open_loop_new_states/subdir.mk
...
clean: clean-Core-2f-Application-2f-MPC-2f-open_loop_new_states

clean-Core-2f-Application-2f-MPC-2f-open_loop_new_states:
	-$(RM) ./Core/Application/MPC/open_loop_new_states/open_loop_new_states.d ./Core/Application/MPC/open_loop_new_states/open_loop_new_states.o ./Core/Application/MPC/open_loop_new_states/open_loop_new_states.su

.PHONY: clean-Core-2f-Application-2f-MPC-2f-open_loop_new_states
